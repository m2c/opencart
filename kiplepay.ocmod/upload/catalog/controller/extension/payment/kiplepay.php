...
class ControllerExtensionPaymentkiplepay extends Controller
{
    ...
    public function index()
    {
        ...
        $data['ord_customfield4'] = "plg_opencart_v3.1.2";
        ...
        $data['dynamic_callback_url'] = $this->url->link('extension/payment/kiplepay/callback');
        $data['version'] = '2.0';
        ...
        if ($this->cart->hasRecurringProducts()) {
            ...
            foreach ($this->cart->getRecurringProducts() as $item) {
                ...
                if ($item['recurring']['frequency'] != "month" && $item['recurring']['frequency'] != "quarterly" ) {
                    echo "<div class='col-sm-12' align='center'><h1> Kiplepay payment support only monthly/quarterly frequency in recurring payment</h1></div>"; exit;
                }
                ...
                $frequency = ($item['recurring']['frequency'] == "month") ? "monthly" : $item['recurring']['frequency'];
